...
export default function MemoryMastersPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center p-4">
      <Brain className="w-24 h-24 text-primary mb-6" />
      <h1 className="text-4xl font-bold text-foreground mb-4">Memory Masters</h1>
      <p className="text-xl text-muted-foreground mb-8">
        Don't forget to check back! This brain-boosting game is in development.
      </p>
       <div className="relative w-full max-w-md h-64 rounded-lg overflow-hidden shadow-lg bg-secondary/30 flex items-center justify-center">
        <Image 
            src="https://picsum.photos/seed/memorygame/400/250" 
            alt="Memory game placeholder" 
            layout="fill" 
            objectFit="cover" 
